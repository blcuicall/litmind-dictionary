<template>
  ...
  <div class="user-ip" v-loading="loading">
      ...
      <el-table
      class="table-list"
      :data="tableData.slice((currentPage-1)*currentPageSize,currentPage*currentPageSize)"
      max-height="800px"
      style="width: 95%">
      <el-table-column
        prop="user_ip"
...
export default {
      ...
      data() {
        return {
          ...
          searchCount:0,
          searchHistoryUrl:  this.GLOBAL.BASE_URL+"/home/redictSearchGetUserIp",
          tableData: [],
          currentTotalSize :0 ,
          currentPageSize :15 ,
          currentPage : 1 ,
      ...
      methods: {
        ...
        getUserIP(){
         // 发送请求 ，输入的用户名 this.baseUrl + "/home/searchGetUserIp
            
            this.isShowLoadingView =  true
            this.$http.get(this.searchHistoryUrl,{emulateJSON:false,withCredentials:true}).then(function(res){
